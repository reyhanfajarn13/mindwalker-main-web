...
export function HeroNewsSection({ item }: HeroNewsSectionProps) {
  return (
    <section
      id="news"
    ...
    >
      ...
      <div className="relative mx-auto w-[min(1120px,100%)]">
        ...
        <article className="group mt-4 grid overflow-hidden rounded-3xl border border-[rgba(255,255,255,0.12)] bg-white shadow-[0_24px_45px_rgba(6,15,29,0.35)] lg:grid-cols-[1.35fr_1fr]">
          <img
            src={item.imageUrl}
            alt={item.title}
            className="h-full min-h-[135px] w-full object-cover grayscale brightness-[0.74] transition-[filter] duration-500 ease-out group-hover:grayscale-0 group-hover:brightness-100"
          />
