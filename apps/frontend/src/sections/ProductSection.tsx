...
const mascotBySlug: Record<string, string> = {
  "mind-ops": "/assets/mascots/mindops-mascot.webp",
  "mind-sec": "/assets/mascots/mindsoc-mascot.webp",
  "mind-graph": "/assets/mascots/mindgraph-mascot.webp",
  "mind-flow": "/assets/mascots/mindflow-mascot.webp",
  visioncraft: "/assets/mascots/visioncraft-mascot.webp"
};
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      setActiveSlug((current) => {
        const currentIndex = sectionSlugs.indexOf(current);
        return sectionSlugs[(currentIndex + 1) % sectionSlugs.length];
      });
    }, AUTO_ADVANCE_MS);
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-[min(1500px,calc(100%-1.5rem))] content-center sm:w-[min(1600px,calc(100%-2rem))]">
        ...
        <div className="mt-6" onMouseEnter={pauseAutoAdvance} onMouseLeave={scheduleResume}>
